...
<head>
    <title>{{ $business_setting->name }}</title>
    <meta charset="utf-8">
...
<body id="top">
    ...
    <div class="wrapper row0">
        <header id="header" class="hoc clear">
            ...
            <div id="logo" class="one_quarter first">
                <h1><a href="index.html"><span>{{ $business_setting->name }}</span></a></h1>
            </div>
            <div class="three_quarter">
                <ul class="nospace clear">
                    <li class="one_third first">
                        <div class="block clear"><a href="#"><i class="fas fa-phone"></i></a> <span><strong>Give
                                    us a call:</strong> {{ $business_setting->phone }}</span></div>
                    </li>
                    <li class="one_third">
                        <div class="block clear"><a href="#"><i class="fas fa-envelope"></i></a>
                            <span><strong>Send us a mail:</strong> {{ $business_setting->email }}</span></div>
                    </li>
                    <li class="one_third">
                        <div class="block clear"><a href="#"><i class="fas fa-clock"></i></a> <span><strong> Mon.
                                    - Sat.:</strong> {{ $business_setting->open_close }}</span></div>
                    </li>
                </ul>
            </div>
            <!-- ################################################################################################ -->
    ...
    <div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
        <div id="pageintro" class="hoc clear">
            ...
            <article>
                ...
                <footer><a class="btn" href="#">Nulla tristique ipsum <i class="fas fa-angle-right"></i></a>
                </footer>
            </article>
            <!-- ################################################################################################ -->
        </div>
        ...
        <main class="hoc container clear">
            ...
            <div class="group center btmspace-80">
                <article class="one_third first"><a class="ringcon btmspace-50" href="#"><i
                    ...
                    <p>Dolor nec magna accumsan tempus mauris lectus enim luctus vitae viverra a pharetra mollis diam
                        phasellus nec dolor sed ornare.</p>
                </article>
                <article class="one_third"><a class="ringcon btmspace-50" href="#"><i
                    ...
                    <p>Nam rhoncus lacus at lorem fusce tempus ut vitae metus fusce hendrerit tempus sapien suspendisse
                        condimentum mollis ligula.</p>
                </article>
                <article class="one_third"><a class="ringcon btmspace-50" href="#"><i class="fas fa-paw"></i></a>
                    ...
                    <p>Enim integer laoreet odio sed neque vestibulum vehicula neque et ornare congue lacus nisi
                        pharetra nisl a pharetra urna metus.</p>
                </article>
            </div>
            <p class="center"><a class="btn" href="#">Consectetuer porttitor <i
    ...
    <div class="wrapper row2">
        <section class="hoc container clear">
            ...
            <article class="one_third first">
                ...
                <p>Sed placerat leo nec tincidunt aliquet ipsum mi ultrices magna eu tempor quam dolor eu sem nullam
                    risus turpis rhoncus vel varius consequat laoreet ac neque pellentesque imperdiet sagittis velit
                    vivamus urna ut dictum erat eu massa aliquam nunc urna ornare.</p>
                <p class="btmspace-30">Tincidunt quis posuere id justo aenean velit ipsum tincidunt aliquet lacinia nec
                    pharetra in purus proin auctor justo ac sem.</p>
                <p><a class="btn" href="#">Donec rutrum justo at <i class="fas fa-angle-right"></i></a></p>
            </article>
            <figure class="one_third"><a class="imgover" href="#"><img src="images/demo/348x420.png"
                        alt=""></a></figure>
            <figure class="one_third"><a class="imgover" href="#"><img src="images/demo/348x420.png"
                        alt=""></a></figure>
            <!-- ################################################################################################ -->
    ...
    <div class="wrapper row3">
        <section class="hoc container clear">
            ...
            <footer class="center"><a class="btn" href="#">Vestibulum suspendisse <i
                        class="fas fa-angle-right"></i></a></footer>
            <!-- ################################################################################################ -->
        </section>
    </div>
    <!-- ################################################################################################ -->
    ...
    <div class="wrapper row2">
        <section class="hoc container clear">
            ...
            <div id="latest" class="group">
                <article class="one_third first"><a class="imgover" href="#"><img
                            src="images/demo/348x261.png" alt=""></a>
                    <div class="excerpt">
                        <h6 class="heading">Elementum laoreet lorem donec</h6>
                        <p>Pede nam quis mauris nunc volutpat elementum sapien in hendrerit justo non nisl sed dictum
                            libero et nisi.</p>
                        <footer><a href="#">Read More <i class="fas fa-angle-right"></i></a></footer>
                    </div>
                </article>
                <article class="one_third"><a class="imgover" href="#"><img src="images/demo/348x261.png"
                            alt=""></a>
                    <div class="excerpt">
                        <h6 class="heading">Vestibulum accumsan sagittis</h6>
                        <p>Orci nulla purus pellentesque risus magna vulputate vitae sodales in aliquam at tortor
                            praesent tincidunt.</p>
                        <footer><a href="#">Read More <i class="fas fa-angle-right"></i></a></footer>
                    </div>
                </article>
                <article class="one_third"><a class="imgover" href="#"><img src="images/demo/348x261.png"
                    ...
                    <div class="excerpt">
                        ...
                        <p>Donec faucibus lorem ut neque pellentesque quam donec imperdiet nisl sed euismod ullamcorper
                            tortor cras.</p>
                        <footer><a href="#">Read More <i class="fas fa-angle-right"></i></a></footer>
                    </div>
                </article>
            </div>
            <footer class="center"><a class="btn" href="#">Pharetra pulvinar risus <i
                        class="fas fa-angle-right"></i></a></footer>
            <!-- ################################################################################################ -->
        </section>
    </div>
    ...
    <div class="wrapper row4">
        <footer id="footer" class="hoc clear">
            ...
            <div class="one_third first">
                ...
                <p>Diam libero interdum at fringilla id interdum eu ante phasellus nec mauris non risus fermentum
                    condimentum in.</p>
                <p class="btmspace-30">Vulputate ante ut adipiscing egestas risus orci tincidunt nulla ac lacinia lacus
                    felis et augue donec lacus [<a href="#"><i class="fas fa-arrow-right"></i></a>]</p>
            ...
            <div class="one_third">
                ...
                <p class="nospace btmspace-15">Elit sed est tortor molestie in consectetuer fringilla suscipit ut odio
                    in.</p>
