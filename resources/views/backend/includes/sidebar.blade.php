    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{url('/')}} " target="_blank">
            <img src="{{ asset('backend/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100"
                alt="main_logo">
            <span class="ms-1 font-weight-bold">RotaryClub</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse   {{Request::is(Request::segment(1) .'/payments*') ? 'show' : ''}}  {{Request::is(Request::segment(1) .'/setting*') ? 'show' : ''}}{{Request::is(Request::segment(1) .'/artisan-command*') ? 'show' : ''}}{{Request::is(Request::segment(1) .'/smtp-settings*') ? 'show' : ''}}"
                    id="settingEX">
                    <ul class="nav ms-4">
                        <li class="nav-item {{Request::is(Request::segment(1) .'/setting*') ? 'active' : ''}}">
                            <a class="nav-link " href="{{route(Request::segment(1) . '.setting.index')}}">
