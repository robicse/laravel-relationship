...
// custom Role - Get the roles associated with the user - Get the users associated with the role
// use App\Models\Role;
...
class UserController extends Controller
{
     ...
     **/
    public function userRoles($id = 1)
    {
        return User::find($id)->roles()->get();
        // return User::find($id)->roles()->orderBy('name')->where('name', 'admin')->get();
        // return Role::find($id)->users()->get();
        // return Role::find($id)->users()->orderBy('name')->where('name', 'admin')->get();
